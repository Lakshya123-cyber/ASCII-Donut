    ...
    while True:
        ...
        while j < 6.28:
            ...
            while i < 6.28:
                ...
                # 11 is the down screen shift
                y = int(11 + 15 * mess * (cosi * cosj2 * sinB + t * cosB))
                # all are casted to int, that is floored
                o = int(x + width * y)

                # multipying by 8 to bring in range 0-11 as 8 * (sqrt(2)) = 11
                ...
                # that is when z[o] is 0 or the prev point is behind the new point
